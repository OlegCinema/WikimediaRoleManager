...
###### DiscordWikipediaBot — бот, созданный специально для автоматизации задач по модерированию серверов Википедии.
...
1. file.py (*отвечает за работу с файлами*).
2. botlike.py (*лайкинг рандомной правки*).
3. bot.py (*основной файл, откуда происходит работа с дискордом*).
...
После того, как вы пригласите вашего бота, в файле [config.json](src/config.json) будет JSON-объект следующего вида:
```
{
"633673794468446270": {
